...
function startGame() {
    ...
    const imageNames =["ufo1.png", "ufo2.png", "ufo3.png", "ufo4.png"]
...
function shot() {
    ...
    splash.style.left =  window.screen.width / 2 + translateY + "px";
...
function resetGame(message) {
   ...
   translateX = 0;
   translateY = 0;
    maxMove = window.screen.width / 2 - 200;
    containerX = 10;
    containerY = 0;
    destroyed = 0;
    ...
    imageContainer.style.innerHTML = "";
}